	...
	//	(an%4 == 0) && (an%100 !=0 || an%400 == 0)
		...
		case 2 -> {
			if ((an%4 == 0) && (an%100 !=0 || an%400 == 0)) {
				days = 29;
				zileAn =366;
				System.out.println("Anul ales de tine are: 366 zile!");
			}else {
				days = 28;
				System.out.println("Anul ales de tine are: 365 zile!");
			}
		}
		default -> System.out.println("luna invalida");
		
		}
		System.out.println("Anul ales de tine are: " + zileAn + " zile!");
